...
Echoe.new('m', '0.0.1') do |p|  
  ...
  p.dependencies = %w{meta_where compass haml cancan paperclip has_scope inherited_resources inherited_resources_views simple_form will_paginate ancestry symboltable}
end  
