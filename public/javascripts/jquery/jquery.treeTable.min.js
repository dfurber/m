...
$.fn.draggableTable = function() {
    return this.each(function(){
        if (!$(this).hasClass('tabledrag-processed'))
            return new DDTable(this);
        else
            $(this).addClass('tabledrag-processed');
    });
};
 ...
 */
var DDTable = function(table, tableSettings) {
  var self = this;
  ...
  if (this.indentEnabled) {
    ...
    var indent = $('<div class="indentation">&nbsp;</div>');
    // Match immediate children of the parent element to allow nesting.
    var testCell = $('tr.draggable:first td:first', table).prepend(indent).prepend(indent.clone());
 ...
 */
DDTable.prototype.hideColumns = function(){
 ...
 */
DDTable.prototype.rowSettings = function(group, row) {
  var field = $('.' + group, row);
 ...
 */
DDTable.prototype.dragRow = function(event, self) {
  if (self.dragObject) {
 ...
 */
DDTable.prototype.dropRow = function(event, self) {
  ...
  if (self.rowObject != null) {
    ...
    if (self.rowObject.changed == true) {
      ...
      if (self.changed == false) {
        //$("<div class='tableDragChangedWarning'>The order has changed. Please click save to record your changes.</div>").insertAfter(self.table).hide().fadeIn('slow');
        self.changed = true;
      }
    }
 ...
 */
DDTable.prototype.getPosition = function(element){
  var left = 0;
  var top  = 0;
 ...
 */
DDTable.prototype.mouseCoords = function(event){
 ...
 */
DDTable.prototype.getMouseOffset = function(target, event) {
 ...
 */
DDTable.prototype.findDropTargetRow = function(x, y) {
  var rows = this.table.tBodies[0].rows;
  for (var n=0; n<rows.length; n++) {
    var row = rows[n];
    var indentDiff = 0;
    // Safari fix see DDTable.prototype.getPosition()
 ...
 */
DDTable.prototype.updateFields = function(changedRow) {
  for (var group in this.tableSettings) {
 ...
 */
DDTable.prototype.updateField = function(changedRow, group) {
 ...
 * may have had.
 */
DDTable.prototype.copyDragClasses = function(sourceRow, targetRow, group) {
...
DDTable.prototype.checkScroll = function(cursorY) {
...
DDTable.prototype.setScroll = function(scrollAmount) {
  var self = this;
...
DDTable.prototype.restripeTable = function() {
 ...
 */
DDTable.prototype.onDrag = function() {
  return null;
};
 ...
 */
DDTable.prototype.row = function(tableRow, method, indentEnabled, maxDepth, addClasses) {
 ...
 *   Whether we want to add classes to this row to indicate child relationships.
 */
DDTable.prototype.row.prototype.findChildren = function(addClasses) {
 ...
 */
DDTable.prototype.row.prototype.isValidSwap = function(row) {
  if (this.indentEnabled) {
    var prevRow, nextRow;
 ...
 */
DDTable.prototype.row.prototype.swap = function(position, row) {
 ...
 */
DDTable.prototype.row.prototype.validIndentInterval = function (prevRow, nextRow) {
 ...
 */
DDTable.prototype.row.prototype.indent = function(indentDiff) {
  ...
  for (var n = 1; n <= Math.abs(indentDiff); n++) {
    ...
    if (indentDiff < 0) {
        if ($('.indentation', this.element).size() > 1) {
            $('.indentation:first', this.group).remove();
            this.indents--;
        }
    }
    else {
      $('td:first', this.group).prepend($("<div class='indentation'></div>"));
      this.indents++;
    }
  }
  if (indentDiff) {
 ...
 */
DDTable.prototype.row.prototype.findSiblings = function(rowSettings) {
 ...
 */
DDTable.prototype.row.prototype.removeIndentClasses = function() {
 ...
 */
DDTable.prototype.row.prototype.markChanged = function() {
  var marker = $("<span class='tableDragChangedMarker'></div>");
 ...
 */
DDTable.prototype.row.prototype.onIndent = function() {
  return null;
};
 ...
 */
DDTable.prototype.row.prototype.onSwap = function(swappedRow) {
  return null;
};
